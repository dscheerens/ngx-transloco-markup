...
function createTestTranspiler(token: string): { transpiler: TestSubstitutionTranspiler; context: TranslationMarkupTranspilerContext } {
    const transpiler = new TestSubstitutionTranspiler(token);
    const context = {
